...
xsec_muangle_mumom = file.Get("xsec_muangle_mumom_cv_cosmicscaled_overlay")
xsec_poly_muangle_mumom = file.Get("xsec_poly_muangle_mumom_cv_cosmicscaled_overlay")
...
cov_file.cd();
cov_matrix_onebin.Write("covariance_matrix_cosmic_onebin");
...
cov_matrix_poly_muangle_mumom.Write("covariance_matrix_poly_cosmic_muangle_mumom");
cov_matrix_onebin_frac.Write("frac_covariance_matrix_cosmic_onebin");
cov_matrix_mumom_frac.Write("frac_covariance_matrix_cosmic_mumom");
cov_matrix_muangle_frac.Write("frac_covariance_matrix_cosmic_muangle");
cov_matrix_muangle_mumom_frac.Write("frac_covariance_matrix_cosmic_muangle_mumom");
cov_matrix_poly_muangle_mumom_frac.Write("frac_covariance_matrix_poly_cosmic_muangle_mumom");
cov_file.Close();
