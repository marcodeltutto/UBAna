...
// Mon May  7 00:11:24 2018 by ROOT version 6.06/06
// from TTree tree/Temperature tree
// found on file: temperatures.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("temperatures.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("temperatures.root");
      }
...
void AnaTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("fDatime", &fDatime, &b_date_fDatime);
