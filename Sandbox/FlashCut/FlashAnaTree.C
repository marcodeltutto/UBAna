#define FlashAnaTree_cxx
#include "FlashAnaTree.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void FlashAnaTree::Loop()
{
//   In a ROOT session, you can do:
//      root> .L FlashAnaTree.C
//      root> FlashAnaTree t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
  ...
  double _beamSpillStarts = 3.1;
  double _beamSpillEnds = 4.9;
  ...
  for (double pe_cut = 0; pe_cut < 3000; pe_cut+=25) {
