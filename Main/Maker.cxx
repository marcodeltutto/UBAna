...
void Main::Maker::MakeFile() 
{
  ...
  _event_histo_misc = new UBXSecMiscHisto();
  _event_histo_misc->Initialize();
...
*/
    ...
    if (isSignal) {
      ...
      _event_histo_misc->hmap_mctruth_nuenergy_gen["total"]->Fill(t->nu_e, event_weight);
      _event_histo_misc->hmap_mctruth_mumom_gen["total"]->Fill(t->true_muon_mom, event_weight);
      _event_histo_misc->hmap_mctruth_mucostheta_gen["total"]->Fill(t->lep_costheta, event_weight);
      _event_histo_misc->hmap_mctruth_muphi_gen["total"]->Fill(t->lep_phi, event_weight);
      if (t->mode == 0) {
        _event_histo_misc->hmap_mctruth_nuenergy_gen["qe"]->Fill(t->nu_e, event_weight);
        _event_histo_misc->hmap_mctruth_mumom_gen["qe"]->Fill(t->true_muon_mom, event_weight);
        _event_histo_misc->hmap_mctruth_mucostheta_gen["qe"]->Fill(t->lep_costheta, event_weight);
        _event_histo_misc->hmap_mctruth_muphi_gen["qe"]->Fill(t->lep_phi, event_weight);
      }
      if (t->mode == 1) {
        _event_histo_misc->hmap_mctruth_nuenergy_gen["res"]->Fill(t->nu_e, event_weight);
        _event_histo_misc->hmap_mctruth_mumom_gen["res"]->Fill(t->true_muon_mom, event_weight);
        _event_histo_misc->hmap_mctruth_mucostheta_gen["res"]->Fill(t->lep_costheta, event_weight);
        _event_histo_misc->hmap_mctruth_muphi_gen["res"]->Fill(t->lep_phi, event_weight);
      }
      if (t->mode == 2) {
        _event_histo_misc->hmap_mctruth_nuenergy_gen["dis"]->Fill(t->nu_e, event_weight);
        _event_histo_misc->hmap_mctruth_mumom_gen["dis"]->Fill(t->true_muon_mom, event_weight);
        _event_histo_misc->hmap_mctruth_mucostheta_gen["dis"]->Fill(t->lep_costheta, event_weight);
        _event_histo_misc->hmap_mctruth_muphi_gen["dis"]->Fill(t->lep_phi, event_weight);
      }
      if (t->mode == 3) {
        _event_histo_misc->hmap_mctruth_nuenergy_gen["coh"]->Fill(t->nu_e, event_weight);
        _event_histo_misc->hmap_mctruth_mumom_gen["coh"]->Fill(t->true_muon_mom, event_weight);
        _event_histo_misc->hmap_mctruth_mucostheta_gen["coh"]->Fill(t->lep_costheta, event_weight);
        _event_histo_misc->hmap_mctruth_muphi_gen["coh"]->Fill(t->lep_phi, event_weight);
      }
      if (t->mode == 10) {
        _event_histo_misc->hmap_mctruth_nuenergy_gen["mec"]->Fill(t->nu_e, event_weight);
        _event_histo_misc->hmap_mctruth_mumom_gen["mec"]->Fill(t->true_muon_mom, event_weight);
        _event_histo_misc->hmap_mctruth_mucostheta_gen["mec"]->Fill(t->lep_costheta, event_weight);
        _event_histo_misc->hmap_mctruth_muphi_gen["mec"]->Fill(t->lep_phi, event_weight);
      }
    } // if is signal
    ...
    if(nu_origin && isSignal /*&& true_pdg==13 && true_origin == 0*/) {
      ...
      _event_histo_misc->hmap_mctruth_nuenergy["total"]->Fill(t->nu_e, event_weight);
      _event_histo_misc->hmap_mctruth_mumom["total"]->Fill(t->true_muon_mom, event_weight);
      _event_histo_misc->hmap_mctruth_mucostheta["total"]->Fill(t->lep_costheta, event_weight);
      _event_histo_misc->hmap_mctruth_muphi["total"]->Fill(t->lep_phi, event_weight);
      if (t->mode == 0) {
        _event_histo_misc->hmap_mctruth_nuenergy["qe"]->Fill(t->nu_e, event_weight);
        _event_histo_misc->hmap_mctruth_mumom["qe"]->Fill(t->true_muon_mom, event_weight);
        _event_histo_misc->hmap_mctruth_mucostheta["qe"]->Fill(t->lep_costheta, event_weight);
        _event_histo_misc->hmap_mctruth_muphi["qe"]->Fill(t->lep_phi, event_weight);
      }
      if (t->mode == 1) {
        _event_histo_misc->hmap_mctruth_nuenergy["res"]->Fill(t->nu_e, event_weight);
        _event_histo_misc->hmap_mctruth_mumom["res"]->Fill(t->true_muon_mom, event_weight);
        _event_histo_misc->hmap_mctruth_mucostheta["res"]->Fill(t->lep_costheta, event_weight);
        _event_histo_misc->hmap_mctruth_muphi["res"]->Fill(t->lep_phi, event_weight);
      }
      if (t->mode == 2) {
        _event_histo_misc->hmap_mctruth_nuenergy["dis"]->Fill(t->nu_e, event_weight);
        _event_histo_misc->hmap_mctruth_mumom["dis"]->Fill(t->true_muon_mom, event_weight);
        _event_histo_misc->hmap_mctruth_mucostheta["dis"]->Fill(t->lep_costheta, event_weight);
        _event_histo_misc->hmap_mctruth_muphi["dis"]->Fill(t->lep_phi, event_weight);
      }
      if (t->mode == 3) {
        _event_histo_misc->hmap_mctruth_nuenergy["coh"]->Fill(t->nu_e, event_weight);
        _event_histo_misc->hmap_mctruth_mumom["coh"]->Fill(t->true_muon_mom, event_weight);
        _event_histo_misc->hmap_mctruth_mucostheta["coh"]->Fill(t->lep_costheta, event_weight);
        _event_histo_misc->hmap_mctruth_muphi["coh"]->Fill(t->lep_phi, event_weight);
      }
      if (t->mode == 10) {
        _event_histo_misc->hmap_mctruth_nuenergy["mec"]->Fill(t->nu_e, event_weight);
        _event_histo_misc->hmap_mctruth_mumom["mec"]->Fill(t->true_muon_mom, event_weight);
        _event_histo_misc->hmap_mctruth_mucostheta["mec"]->Fill(t->lep_costheta, event_weight);
        _event_histo_misc->hmap_mctruth_muphi["mec"]->Fill(t->lep_phi, event_weight);
      }
  ...
  LOG_NORMAL() << "Saving Misc Event Histo." << std::endl;
 
  file_out->WriteObject(_event_histo_misc, "UBXSecMiscHisto");

  LOG_NORMAL() << "Misc Event Histo saved." << std::endl;
