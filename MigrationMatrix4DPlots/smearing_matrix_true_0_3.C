...
//=========  (Sat Sep 22 12:04:03 2018) by ROOT version6.06/06
   ...
   c1_n63->Range(-1.25,-0.3125,1.25,2.8125);
   c1_n63->SetFillColor(10);
   c1_n63->SetBorderMode(0);
   c1_n63->SetBorderSize(2);
   c1_n63->SetFrameLineWidth(2);
   c1_n63->SetFrameBorderMode(0);
   c1_n63->SetFrameLineWidth(2);
   c1_n63->SetFrameBorderMode(0);
   Double_t xAxis58[9] = {-1, 0, 0.27, 0.45, 0.62, 0.76, 0.86, 0.94, 1}; 
   Double_t yAxis4[5] = {0, 0.3, 0.45, 0.77, 2.5}; 
   
   TH2D *_reco_per_true = new TH2D("_reco_per_true","True Bin (0, 3)",8, xAxis58,4, yAxis4);
   ...
   pt->SetFillColor(0);
   pt->SetTextFont(42);
   TText *AText = pt->AddText("True Bin (0, 3)");
   pt->Draw();
   c1_n63->Modified();
   c1_n63->cd();
